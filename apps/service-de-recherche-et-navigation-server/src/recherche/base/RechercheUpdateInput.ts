...
class RechercheUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ItinRaireUpdateManyWithoutRecherchesInput,
  })
  @ValidateNested()
  @Type(() => ItinRaireUpdateManyWithoutRecherchesInput)
  @IsOptional()
  @Field(() => ItinRaireUpdateManyWithoutRecherchesInput, {
    nullable: true,
  })
...
export { RechercheUpdateInput as RechercheUpdateInput };
